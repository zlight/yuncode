...
def _support_channel(c) -> rx.Component:
    return rx.el.a(
        rx.el.div(
            rx.icon(c["icon"], size=18, class_name="text-blue-400"),
        ...
        rx.el.h4(
            c["title"], class_name="text-white font-semibold text-sm mb-1"
        ),
        rx.el.p(
            c["desc"], class_name="text-xs text-gray-500 mb-3 min-h-[2.5rem]"
        ),
        rx.el.span(
            c["action"],
