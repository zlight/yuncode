                        ...
                        rx.cond(
                            ...
                            rx.el.div(
                                ...
                                rx.el.p(
                                    ...
                                    class_name="text-rose-300 text-xs font-semibold leading-relaxed",
                                ),
                                class_name="flex items-start gap-2 px-3 py-2.5 rounded-lg bg-rose-500/10 border border-rose-500/30 mb-5 animate-fadeIn",
                            ),
                            rx.fragment(),
                        ),
                        rx.el.button(
